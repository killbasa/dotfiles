...
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "clone" -d 'Clone a repository'
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "complete" -d 'Generate autocompletions. Example: `kb complete fish > ~/.config/fish/completions/kb.fish`'
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "config" -d 'Manage the config file'
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "dotfiles" -d 'Manage dotfiles'
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "infra" -d 'Manage infra'
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "open" -d 'Open a package\'s home page'
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "template" -d 'Generate a repository from a template'
complete -c kb -n "__fish_kb_using_subcommand help; and not __fish_seen_subcommand_from clone complete config dotfiles infra open template help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
